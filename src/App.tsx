...
export const App: React.FC = () => {
  ...
  const IS_LIGHT_ACTIVE_SORT_ALPHABETICAL: string = 'alphabetical';
  const IS_LIGHT_ACTIVE_SORT_LENGTH: string = 'length';
  const IS_LIGHT_ACTIVE_SORT_REVERSE: string = 'reverse';
